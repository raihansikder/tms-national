@extends('projects.tms.layouts.module.form.template')
<?php
/**
 ...
 * @var \App\Projects\Tms\Modules\Settings\SettingViewProcessor $view
 */
$setting = $element;
...
@section('js')
    @parent
    @include('projects.tms.modules.settings.form.js')
    <script>
